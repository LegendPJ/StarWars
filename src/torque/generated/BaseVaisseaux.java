...
public abstract class BaseVaisseaux extends BaseObject
{
    ...
    public Object getByPeerName(String name)
    {
        ...
        if (name.equals(VaisseauxPeer.ATTAQUE))
        {
            return new Integer(getAttaque());
        }
        if (name.equals(VaisseauxPeer.DEGATS))
        {
            return new Integer(getDegats());
        }
        if (name.equals(VaisseauxPeer.CHAMP))
        {
            return new Integer(getChamp());
        }
        if (name.equals(VaisseauxPeer.ENERGIE))
        {
            return new Integer(getEnergie());
        }
        if (name.equals(VaisseauxPeer.PA))
        {
            return new Integer(getPa());
        }
        return null;
        ...
        throws TorqueException, IllegalArgumentException
    {
      ...
      if (VaisseauxPeer.ATTAQUE.equals(name))
        {
            return setByName("Attaque", value);
        }
      if (VaisseauxPeer.DEGATS.equals(name))
        {
            return setByName("Degats", value);
        }
      if (VaisseauxPeer.CHAMP.equals(name))
        {
            return setByName("Champ", value);
        }
      if (VaisseauxPeer.ENERGIE.equals(name))
        {
            return setByName("Energie", value);
        }
      if (VaisseauxPeer.PA.equals(name))
        {
