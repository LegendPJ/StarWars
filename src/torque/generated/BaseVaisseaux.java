...
public abstract class BaseVaisseaux extends BaseObject
{
    ...
    public void setNom(String v) throws TorqueException
    {
        ...
        if (collPartiess != null)
        {
            for (int i = 0; i < collPartiess.size(); i++)
            {
                ((Parties) collPartiess.get(i))
                        .setTour(v);
            }
        }
    ...
    /**
     * Collection to store aggregation of collPartiess
     */
    protected List collPartiess;

    /**
     * Temporary storage of collPartiess to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initPartiess()
    {
        if (collPartiess == null)
        {
            collPartiess = new ArrayList();
        }
    }


    /**
     * Method called to associate a Parties object to this object
     * through the Parties foreign key attribute
     *
     * @param l Parties
     * @throws TorqueException
     */
    public void addParties(Parties l) throws TorqueException
    {
        getPartiess().add(l);
        l.setVaisseaux((Vaisseaux) this);
    }
    ...
    /**
     * Method called to associate a Parties object to this object
     * through the Parties foreign key attribute using connection.
     *
     * @param l Parties
     * @throws TorqueException
     */
    public void addParties(Parties l, Connection con) throws TorqueException
    {
        getPartiess(con).add(l);
        l.setVaisseaux((Vaisseaux) this);
    }

    /**
     * The criteria used to select the current contents of collPartiess
     */
    private Criteria lastPartiessCriteria = null;

    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getPartiess(new Criteria())
     *
     * @return the collection of associated objects
     * @throws TorqueException
     */
    public List getPartiess()
        throws TorqueException
    {
        if (collPartiess == null)
        {
            collPartiess = getPartiess(new Criteria(10));
        }
        return collPartiess;
    }
     ...
     * an identical criteria, it returns the collection.
     * Otherwise if this Vaisseaux has previously
     * been saved, it will retrieve related Partiess from storage.
     * If this Vaisseaux is new, it will return
     * an empty collection or the current collection, the criteria
     * is ignored on a new object.
     *
     * @throws TorqueException
     */
    public List getPartiess(Criteria criteria) throws TorqueException
    {
        if (collPartiess == null)
        {
            if (isNew())
            ...
            {
                criteria.add(PartiesPeer.TOUR, getNom() );
                collPartiess = PartiesPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                // one, just return the collection.
                criteria.add(PartiesPeer.TOUR, getNom());
                if (!lastPartiessCriteria.equals(criteria))
                {
                    collPartiess = PartiesPeer.doSelect(criteria);
                }
            }
        }
        lastPartiessCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getPartiess(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getPartiess(Connection con) throws TorqueException
    {
        if (collPartiess == null)
        {
            collPartiess = getPartiess(new Criteria(10), con);
        }
        return collPartiess;
    }
     ...
     * that is taken as input
     */
    public List getPartiess(Criteria criteria, Connection con)
            throws TorqueException
    {
        if (collPartiess == null)
        {
            ...
            {
                 criteria.add(PartiesPeer.TOUR, getNom());
                 collPartiess = PartiesPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     * actually need in Vaisseaux.
     */
    protected List getPartiessJoinVaisseaux(Criteria criteria)
        throws TorqueException
    {
        if (collPartiess == null)
        {
            ...
            {
                criteria.add(PartiesPeer.TOUR, getNom());
                collPartiess = PartiesPeer.doSelectJoinVaisseaux(criteria);
            }
        }
        else
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (collPartiess != null)
            {
                for (int i = 0; i < collPartiess.size(); i++)
                {
                    ((Parties) collPartiess.get(i)).save(con);
                }
            }
    ...
    protected Vaisseaux copyInto(Vaisseaux copyObj, boolean deepcopy) throws TorqueException
    {
        ...
        List vPartiess = getPartiess();
        if (vPartiess != null)
        {
            for (int i = 0; i < vPartiess.size(); i++)
            {
                Parties obj = (Parties) vPartiess.get(i);
                copyObj.addParties(obj.copy());
            }
        }
        else
        {
            copyObj.collPartiess = null;
        }
    ...
    protected Vaisseaux copyInto(Vaisseaux copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        ...
        List vPartiess = getPartiess(con);
        if (vPartiess != null)
        {
            for (int i = 0; i < vPartiess.size(); i++)
            {
                Parties obj = (Parties) vPartiess.get(i);
                copyObj.addParties(obj.copy(con), con);
            }
        }
        else
        {
