...
public abstract class BaseObjetsVaisseaux extends BaseObject
{
    ...
    /** The value for the dureeRestante field */
    private int dureeRestante = 0;
     ...
     * @param v new value
     */
    public void setEquipe(boolean v) 
    {
    ...
    /**
     * Set the value of DureeRestante
     *
     * @param v new value
     */
    public void setDureeRestante(int v) 
    {

        if (this.dureeRestante != v)
        {
            this.dureeRestante = v;
            setModified(true);
        }
    ...
    public static synchronized List getFieldNames()
    {
        if (fieldNames == null)
        {
            ...
            fieldNames.add("Equipe");
            fieldNames.add("DureeRestante");
    ...
    public Object getByName(String name)
    {
        ...
        if (name.equals("Equipe"))
        {
            return new Boolean(getEquipe());
        }
        if (name.equals("DureeRestante"))
        {
            return new Integer(getDureeRestante());
        }
        return null;
    }
        ...
        throws TorqueException, IllegalArgumentException
    {
        ...
        if (name.equals("Equipe"))
        {
            ...
            setEquipe(((Boolean)value).booleanValue());
            return true;
        }
        if (name.equals("DureeRestante"))
        {
            ...
            setDureeRestante(((Integer) value).intValue());
            return true;
        }
        return false;
    }
    ...
    public Object getByPeerName(String name)
    {
        ...
        if (name.equals(ObjetsVaisseauxPeer.EQUIPE))
        {
            return new Boolean(getEquipe());
        }
        if (name.equals(ObjetsVaisseauxPeer.DUREE_RESTANTE))
        {
            return new Integer(getDureeRestante());
        }
        return null;
        ...
        throws TorqueException, IllegalArgumentException
    {
      ...
      if (ObjetsVaisseauxPeer.EQUIPE.equals(name))
        {
            return setByName("Equipe", value);
        }
      if (ObjetsVaisseauxPeer.DUREE_RESTANTE.equals(name))
        {
            return setByName("DureeRestante", value);
        }
        return false;
    }
    ...
    protected ObjetsVaisseaux copyInto(ObjetsVaisseaux copyObj, boolean deepcopy) throws TorqueException
    {
        ...
        copyObj.setEquipe(equipe);
        copyObj.setDureeRestante(dureeRestante);
    ...
    public String toString()
    {
        ...
        str.append("Equipe = ")
           .append(getEquipe())
           .append("\n");
        str.append("DureeRestante = ")
           .append(getDureeRestante())
           .append("\n");
        return(str.toString());
    }
}
