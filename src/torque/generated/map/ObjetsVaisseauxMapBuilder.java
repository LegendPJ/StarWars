...
public class ObjetsVaisseauxMapBuilder implements MapBuilder
{
  ...
  // ------------- Column: nom_objet --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: equipe --------------------
        cMap = new ColumnMap( "equipe", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "BOOLEANINT" );
        cMap.setUsePrimitive(true);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "Equipe" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("Equipe ou non");
        cMap.setDefault("0");
        cMap.setInheritance("false");
        cMap.setPosition(4);
        tMap.addColumn(cMap);
  // ------------- Column: duree_restante --------------------
        cMap = new ColumnMap( "duree_restante", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(true);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "DureeRestante" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("Nombre de tours restants pour lobjet equipe");
        cMap.setDefault("0");
        cMap.setInheritance("false");
        cMap.setPosition(5);
        tMap.addColumn(cMap);
