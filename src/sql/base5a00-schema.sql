...
COMMENT ON COLUMN vaisseaux.attaque IS 'attaque du vaisseau';
COMMENT ON COLUMN vaisseaux.degats IS 'degats du vaisseau';
COMMENT ON COLUMN vaisseaux.champ IS 'champ du vaisseau';
COMMENT ON COLUMN vaisseaux.energie IS 'energie du vaisseau';
COMMENT ON COLUMN vaisseaux.pa IS 'points d'action du vaisseau';
...
COMMENT ON COLUMN objets.nom IS 'Nom de l'objet';
...
COMMENT ON COLUMN objets_vaisseaux.nom_objet IS 'Nom de l'objet';
...
COMMENT ON COLUMN objets_parties.nom_objet IS 'Nom de l'objet';
